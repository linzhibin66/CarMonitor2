 ...
 */
public class HistorySearchGridViewAdapter extends BaseAdapter{

    private List<String> historyList = new ArrayList<>();

    private Context context;

    public HistorySearchGridViewAdapter(Context context, List<String> historyList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null) {
            ...
            convertView = View.inflate(context, R.layout.history_gridview_item, null);
