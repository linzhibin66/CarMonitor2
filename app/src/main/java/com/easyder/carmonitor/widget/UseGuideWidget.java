...
public class UseGuideWidget {
    ...
    private String urlStr = HttpUtils.HTTPHOST + HttpUtils.USEGUIDEDIR+ "operating_guide.html";


    public UseGuideWidget(Context context, LayoutBackListener listener) {
    ...
    public UseGuideWidget(Context context, View rootView, LayoutBackListener listener) {
        this.context = context;
        this.listener = listener;
...
//                        System.out.println("onReceivedTitle title = "+title);
    ...
    private void initTitle(View rootiew) {
        ...
        title_text.setText(context.getString(R.string.use_guide));
