...
public class DialogPlus {
  ...
  public void changeHolderContentView(View contentView){
    ...
    if (builder.isExpanded()) {
      initExpandAnimator((Activity) builder.getContext(), builder.getDefaultContentHeight(), builder.getContentParams().gravity);
    }
  ...
  private void initContentView(LayoutInflater inflater, View header, View footer, BaseAdapter adapter,
    ...
    params.gravity = builder.getgravity();
...
//    decorView.addView(view,new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
  ...
  public  View.OnTouchListener getCancelTouchListener(){
    return onCancelableTouchListener;
  }

  public void setOnBackPressListener(OnBackPressListener onBackPressListener) {
    this.onBackPressListener = onBackPressListener;
    builder.setOnBackPressListener(onBackPressListener);
  }
