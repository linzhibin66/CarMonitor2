...
public class NumberPickerView extends View{
    ...
    private static final int DEFAULT_TEXT_COLOR_NORMAL = 0XFFA8A8A8;

    // default text color of selected item
    private static final int DEFAULT_TEXT_COLOR_SELECTED = 0XFF333333;
    ...
    private static final int DEFAULT_TEXT_SIZE_HINT_SP = 16;
    ...
    private static final int DEFAULT_MARGIN_END_OF_HINT_DP = 2;

    // default divider's color
    private static final int DEFAULT_DIVIDER_COLOR = 0XFFF0F0F1;
    ...
    public void setCruuDrawFirstItemIndex(int index){
        if(index>= mMinValue && index <= mMaxValue) {
    ...
    private void drawContent(Canvas canvas){
        ...
        for(int i = 0; i < mShowCount + 1; i++){
            ...
            if(0 <= index && index < getOneRecycleSize()){
                ...
                canvas.drawText(str.toString()+ mHintText, mViewCenterX,
