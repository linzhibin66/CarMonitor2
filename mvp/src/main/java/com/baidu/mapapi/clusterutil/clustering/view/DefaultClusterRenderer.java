...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    private OnCreatMarkerListener mOnCreatMarkerListener;
    ...
    protected void onClusterItemRendered(T clusterItem, Marker marker) {
        if(mOnCreatMarkerListener != null){
            mOnCreatMarkerListener.onMarkerCreat(marker);
        }
    }
    ...
    private class CreateMarkerTask {
        ...
        private void perform(MarkerModifier markerModifier) {
            ...
            if (!shouldRenderAsCluster(cluster)) {
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        markerOptions.rotate(item.getRotate());
            ...
            marker.setTitle("cluster"+ cluster.getSize());
            marker.setToTop();
    ...
    public void setOnCreatMarkerListener(OnCreatMarkerListener listener){
        mOnCreatMarkerListener = listener;
    }
