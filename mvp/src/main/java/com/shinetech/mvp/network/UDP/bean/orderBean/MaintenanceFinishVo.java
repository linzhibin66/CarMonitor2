...
public class MaintenanceFinishVo extends BaseVo {
     ...
     * 安装记录
     */
    private byte[] maintenanceResult;
    ...
    public MaintenanceFinishVo(String orderName, String orderNumber, byte[] maintenanceResult) {
        this.orderName = orderName;
        this.orderNumber = orderNumber;
        this.maintenanceResult = maintenanceResult;
        requestProtocolHead = Protocol.RESPONSE_PROTOCOL_MAINTENANCE_FINISH_BEAT;
    ...
    public Object[] getProperties() {
        return new Object[]{orderName, orderNumber, maintenanceResult};
    }
    ...
    public byte[] getMaintenanceResult() {
        return maintenanceResult;
    }

    public void setMaintenanceResult(byte[] maintenanceResult) {
        this.maintenanceResult = maintenanceResult;
    }
