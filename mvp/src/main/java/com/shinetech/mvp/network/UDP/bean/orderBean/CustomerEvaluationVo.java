...
public class CustomerEvaluationVo extends BaseVo {
    ...
    public CustomerEvaluationVo(String orderName, String orderNumber, byte[] evaluation) {
        this.orderName = orderName;
        this.orderNumber = orderNumber;
        this.evaluation = evaluation;
        requestProtocolHead = Protocol.RESPONSE_PROTOCOL_CUSTOMER_EVALUATION_BEAT;
    ...
    public Object[] getProperties() {
        return new Object[]{orderName, orderNumber, evaluation};
    }
